...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/fridaychallenge.exe
...
${OBJECTDIR}/DurchschnittsRechner.o: DurchschnittsRechner.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/DurchschnittsRechner.o DurchschnittsRechner.c

${OBJECTDIR}/EinheitenUmrechner.o: EinheitenUmrechner.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/EinheitenUmrechner.o EinheitenUmrechner.c

${OBJECTDIR}/NotenRechner.o: NotenRechner.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/NotenRechner.o NotenRechner.c

${OBJECTDIR}/ThreeGames.o: ThreeGames.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ThreeGames.o ThreeGames.c
